...
TEST_CASE("tainted array of ints operates correctly", "[tainted arrays]") {
  ...
  REQUIRE(t_testarr[0].UNSAFE_sandboxed() == 5);
  REQUIRE(t_testarr[1].UNSAFE_sandboxed() == 7);
  REQUIRE(t_testarr[2].UNSAFE_sandboxed() == 12);
  REQUIRE_THROWS(t_testarr[3].UNSAFE_sandboxed() == 0);
