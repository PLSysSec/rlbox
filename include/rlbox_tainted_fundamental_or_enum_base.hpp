/**
 * @file rlbox_tainted_fundamental_or_enum_base.hpp
...
class tainted_fundamental_or_enum_base
 ...
 protected:
  static_assert(
      ...
      "tainted_fundamental_or_enum_base only supports fundamental_or_enum");
   ...
   */
  using tainted_boolean_hint_t = rlbox::tainted_boolean_hint<bool, TSbx>;

  /**
   * @brief The current class's type
   */
  using this_t = tainted_fundamental_or_enum_base<TUseAppRep, TAppRep, TSbx>;
 ...
 public:
  /**
   * @brief Construct a new tainted_fundamental_or_enum_base object
   */
  inline tainted_fundamental_or_enum_base() = default;
  /**
   * @brief Copy constructor: Construct a new tainted_fundamental_or_enum_base
   * object
   */
  inline tainted_fundamental_or_enum_base(const this_t&) = default;
  /**
   * @brief Move constructor: Construct a new tainted_fundamental_or_enum_base
   * object
   */
  inline tainted_fundamental_or_enum_base(this_t&&) noexcept = default;
   ...
   */
  template <template <typename, typename> typename TWrap, typename TAppRepOther,
            RLBOX_REQUIRE(!std::is_same_v<this_t, TWrap<TAppRepOther, TSbx>> &&
                          std::is_constructible_v<
                              detail::tainted_rep_t<TAppRep>, TAppRepOther>)>
  inline tainted_fundamental_or_enum_base(
  ...
  inline tainted_fundamental_or_enum_base(const TOther& aOther)
      : data([&] {
          if constexpr (TUseAppRep) {
            return aOther;
          } else {
  ...
  /**
   * @brief Destroy the tainted_fundamental_or_enum_base object
   */
  inline ~tainted_fundamental_or_enum_base() = default;
